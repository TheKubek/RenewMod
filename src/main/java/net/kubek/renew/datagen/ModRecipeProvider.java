    ...
    protected RecipeGenerator getRecipeGenerator(RegistryWrapper.WrapperLookup wrapperLookup, RecipeExporter recipeExporter) {
        return new RecipeGenerator(wrapperLookup,recipeExporter) {
            ...
            public void generate() {
                ...
                createShaped(RecipeCategory.MISC, ModItems.STAFF_OF_DOMINANCE)
                            .pattern(" # ")
                            .pattern("XDX")
                            .pattern(" X ")
                ...
                createShaped(RecipeCategory.COMBAT, ModItems.DANCER_SWORD)
                            .pattern("NXI")
                            .pattern("GSG")
                            .pattern("IXN")
                            .input('S',Items.STICK)
                            ...
                            .offerTo(recipeExporter);
                createShaped(RecipeCategory.COMBAT, ModItems.WOODEN_CUTLASS)
                            .pattern(" X ")
                            .pattern(" X ")
                            .pattern("XS ")
                            .input('S',Items.STICK)
                            ...
                            .offerTo(recipeExporter);
                createShaped(RecipeCategory.COMBAT, ModItems.STONE_CUTLASS)
                            .pattern(" X ")
                            .pattern(" X ")
                            .pattern("XS ")
                            .input('S',Items.STICK)
                    ...
                    offerNetheriteUpgradeRecipe(ModItems.DIAMOND_CUTLASS,RecipeCategory.COMBAT,ModItems.NETHERITE_CUTLASS);
                createShaped(RecipeCategory.COMBAT, ModItems.WOODEN_SCYTHE)
                            .pattern("XX ")
                            .pattern(" #X")
                            .pattern(" # ")
                            .input('X',ItemTags.PLANKS)
                            ...
                            .criterion(hasItem(Items.STICK),conditionsFromItem(Items.STICK))
                            .offerTo(recipeExporter);
                createShaped(RecipeCategory.COMBAT, ModItems.STONE_SCYTHE)
                            .pattern("XX ")
                            .pattern(" #X")
                            .pattern(" # ")
                            .input('X',ItemTags.STONE_TOOL_MATERIALS)
                            ...
                            .criterion(hasItem(Items.BASALT),conditionsFromItem(Items.BASALT))
                            .offerTo(recipeExporter);
                createShaped(RecipeCategory.MISC,ModItems.COSMETIC_DICE)
                            .pattern("SWS")
                            .pattern("WLW")
                            .pattern("SWS")
                ...
                createShaped(RecipeCategory.COMBAT,OrbOfDominanceTools.ORB_OF_DOMINANCE_SWORD)
                            .pattern("N")
                            .pattern("N")
                            .pattern("O")
                            ...
                            .offerTo(recipeExporter);
                createShaped(RecipeCategory.TOOLS,OrbOfDominanceTools.ORB_OF_DOMINANCE_AXE)
                            .pattern("ON")
                            .pattern("SN")
                            .pattern("S ")
                            .input('N',Items.NETHERITE_INGOT)
                            ...
                            .offerTo(recipeExporter);
                createShaped(RecipeCategory.TOOLS,OrbOfDominanceTools.ORB_OF_DOMINANCE_PICKAXE)
                            .pattern("NON")
                            .pattern(" S ")
                            .pattern(" S ")
                            .input('N',Items.NETHERITE_INGOT)
                            ...
                            .offerTo(recipeExporter);
                createShaped(RecipeCategory.TOOLS,OrbOfDominanceTools.ORB_OF_DOMINANCE_SHOVEL)
                            .pattern("O")
                            .pattern("N")
                            .pattern("S")
                            .input('N',Items.NETHERITE_INGOT)
                            ...
                            .offerTo(recipeExporter);
                createShaped(RecipeCategory.TOOLS,OrbOfDominanceTools.ORB_OF_DOMINANCE_HOE)
                            .pattern("ON")
                            .pattern("N ")
                            .pattern("S ")
                            .input('N',Items.NETHERITE_INGOT)
                            ...
                            .offerTo(recipeExporter);
                createShaped(RecipeCategory.COMBAT,ModItems.ORB_OF_DOMINANCE_HELMET)
                            .pattern("NON")
                            .pattern("N N")
                            .input('N',Items.NETHERITE_INGOT)
                            ...
                            .offerTo(recipeExporter);
                createShaped(RecipeCategory.COMBAT,ModItems.ORB_OF_DOMINANCE_CHESTPLATE)
                            .pattern("N N")
                            .pattern("NON")
                            .pattern("NNN")
                            .input('N',Items.NETHERITE_INGOT)
                            ...
                            .offerTo(recipeExporter);
                createShaped(RecipeCategory.COMBAT,ModItems.ORB_OF_DOMINANCE_LEGGINGS)
                            .pattern("NON")
                            .pattern("N N")
                            .pattern("N N")
                            .input('N',Items.NETHERITE_INGOT)
                            ...
                            .offerTo(recipeExporter);
                createShaped(RecipeCategory.COMBAT,ModItems.ORB_OF_DOMINANCE_BOOTS)
                            .pattern("N N")
                            .pattern("NON")
                            .input('N',Items.NETHERITE_INGOT)
                            ...
                            .offerTo(recipeExporter);
                createShaped(RecipeCategory.COMBAT,OrbOfDominanceTools.ORB_OF_DOMINANCE_CUTLASS)
                            .pattern("N ")
                            .pattern("N ")
                            .pattern("SO")
                            .input('N',Items.NETHERITE_INGOT)
                            ...
                            .criterion(hasItem(OrbOfDominanceParts.ORB_OF_DOMINANCE_PART_ONE),conditionsFromItem(OrbOfDominanceParts.ORB_OF_DOMINANCE_PART_ONE))
                            .offerTo(recipeExporter);
                createShaped(RecipeCategory.COMBAT,OrbOfDominanceTools.ORB_OF_DOMINANCE_SCYTHE)
                            .pattern("NN ")
                            .pattern(" ON")
                            .pattern(" S ")
                            .input('N',Items.NETHERITE_INGOT)
                            ...
                            .criterion(hasItem(OrbOfDominanceParts.ORB_OF_DOMINANCE_PART_FIVE),conditionsFromItem(OrbOfDominanceParts.ORB_OF_DOMINANCE_PART_FIVE))
                            .offerTo(recipeExporter);
                createShaped(RecipeCategory.MISC, ModItems.DOMINANCE_DICE)
                            .pattern("CBC")
                            .pattern("BNB")
                            .pattern("CBC")
                            ...
                            .offerTo(recipeExporter);
                    createShaped(RecipeCategory.MISC, ModItems.GLACIER_SCYTHE)
                            .pattern("BB ")
                            .pattern(" SB")
                            .pattern(" B ")
                    ...
                    createShapeless(RecipeCategory.MISC,ModItems.ORB_OF_DOMINANCE)
            ...
            private void registerScytheCrafting(Item input, Item output, RecipeExporter recipeExporter) {
            ...
            private void registerCutlassCrafting(Item input, Item output, RecipeExporter recipeExporter) {
                createShaped(RecipeCategory.COMBAT,output)
                        .pattern(" X ")
                        .pattern(" X ")
                        .pattern(" #X")
